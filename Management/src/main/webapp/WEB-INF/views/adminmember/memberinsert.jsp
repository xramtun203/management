	...
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ms-auto mt-2 mt-lg-0">
							...
							<a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">회원 정보</a>
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="./MemberLogOut.do">로그 아웃</a>
			...
			<div class="container-fluid centerbox01">
				...
				<div>
				<!-- 액션안에 서블릿 -->
					<form id="signupForm" name="join" action="./MemberInsert.do"
							...
							<div>
								...
								<p>
									<label for="id"> 아이디* </label> <input type="text" id="id"
										name="id" maxlength="20" size="20" placeholder="아이디 Varchar2(20)">
								</p>
								<p>
								...
								<div>
									...
									<input type="button" style="border-radius: 5px;" value="취소" onclick="location.href='./MemberList.do'">
								</div>
							</div>
						</fieldset>
					</form>
