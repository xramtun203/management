...
$(function() {
	$("#limit").change(function() {
		location.href = "./MemberSearch.do?limit="+$(this).val();
	})
...
<body>
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
						...
						<ul class="navbar-nav ms-auto mt-2 mt-lg-0">
							...
							<li class="nav-item dropdown"><a
								...
								<div class="dropdown-menu dropdown-menu-end"
									aria-labelledby="navbarDropdown">
									<div class="dropdown-divider"></div>
									<a class="dropdown-item" href="./MemberLoginm.do">로그 아웃</a> <a
			...
			<div class="container-fluid centerbox01">
				...
				<div style="width: 90%; margin: 0 auto; text-align: center;">
					<p class="allPost" style="float: left;">
						전체 글: &nbsp; <strong>${searchlistcount}</strong>개
					...
					<table class="tableop01">
						<c:choose>
							<c:when test="${searchlistcount>0}">
								...
								<tbody>
									<c:forEach var="search" items="${searchMemberlist}">
										<tr class="lineH01">
											<td class="fontsty">${search.name}</td>
											<td class="fontsty"><a style="text-decoration: none;"
												href="./MemberDetail.do?id=${search.id}">${search.id}</a></td>
											<td class="fontsty">${search.mobile}</td>
										</tr>
									</c:forEach>
							</c:when>
						</c:choose>
			...
			<div>
				<div class="postbox01">
					<form id="searchForm" action="./MemberSearch.do" method="post"
						name="searchForm">
						<fieldset>
							<div>
